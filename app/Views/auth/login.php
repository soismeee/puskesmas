                            ...
                            <div class="p-5">
                                ...
                                <form class="user" action="/login/auth" method="POST">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="username" id="username" aria-describedby="username" value="<?= old('username'); ?>" placeholder="Masukan username anda">
                                    </div>
                                    <div class="form-group">
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="/login/register">Buat akun baru!</a>
                                </div>
                            </div>
                        </div>
