    ...
    <div class="card-body">
        ...
        <form method="post" action="/datarm/simpan">
            <div class="form-group row">
                <label for="tanggal_periksa" class="col-sm-2 col-form-label">Nomor RM</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="id_rm" name="id_rm" readonly>
                </div>
            </div>
            <div class="form-group row">
